  ...
  <body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex space-x-8 items-center">
            <a href="#" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition font-medium">Home</a>
            <a href="#features" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition font-medium">Features</a>
            <a href="#health-tips" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition font-medium">Health Tips</a>
            <a href="#contact" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition font-medium">Contact</a>
            <button id="theme-toggle" class="p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm">
    ...
    <section class="min-h-screen flex flex-col pt-16">
      <div class="flex flex-1">
        <div class="w-1/2 bg-[#F5F5F5] dark:bg-gray-800 min-h-screen">
          <div class="px-12 py-20">
            <div class="max-w-xl">
              <div class="flex items-center space-x-2 mb-6">
                <span class="px-3 py-1 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 rounded-full">AI-Powered</span>
                <span class="px-3 py-1 text-sm font-medium text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/30 rounded-full">Personalized</span>
              </div>
              <h1 class="text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                Your Personal<br/>
                <span class="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">AI Health Diet</span><br/>
                Assistant
              </h1>
              ...
              <div class="flex space-x-4">
                ...
                <button class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 py-4 rounded-xl font-semibold hover:bg-white dark:hover:bg-gray-700 hover:shadow-lg transition duration-300 transform hover:-translate-y-1 flex items-center space-x-2">
      ...
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="p-6 rounded-2xl bg-gray-50 dark:bg-gray-700 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-white">24/7 AI Support</h3>
            <p class="text-gray-600 dark:text-gray-300">Get instant answers to your nutrition questions with our AI-powered chat support.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Health Tips Section -->
    <section id="health-tips" class="py-20 bg-gray-50 dark:bg-gray-900">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
            ...
            <div class="p-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Balanced Diet Essentials</h3>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
            ...
            <div class="p-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Fitness & Nutrition</h3>
              <p class="text-gray-600 dark:text-gray-300">Discover how to combine proper nutrition with exercise for optimal health results.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="contact" class="py-20 bg-white dark:bg-gray-800">
      <div class="max-w-7xl mx-auto px-4">
        <h2 class="text-4xl font-bold text-center mb-12 bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">Get in Touch</h2>
        <div class="max-w-2xl mx-auto">
          <form class="space-y-6">
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Name</label>
              <input type="text" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"/>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Email</label>
              <input type="email" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"/>
            </div>
            <div>
      ...
      <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p class="text-gray-600 dark:text-gray-300">RMP MINDS is your AI-powered health companion, dedicated to helping you achieve your wellness goals.</p>
          </div>
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="#features" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Features</a></li>
              <li><a href="#health-tips" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Health Tips</a></li>
              <li><a href="#contact" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Contact</a></li>
            </ul>
          </div>
          <div>
            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Contact</h3>
            <ul class="space-y-2">
              <li class="text-gray-600 dark:text-gray-300">Email: info@rmpminds.com</li>
    ...
    <script>
      ...
      const images = [
        ...
        "https://images.unsplash.com/photo-1495461199391-8c39ab674295?q=80&w=1200",
      ...
      function createSlide(src, className) {
        ...
        slide.className = `absolute w-full h-full [backface-visibility:hidden] [transform-style:preserve-3d] transition-all duration-800 ease-[cubic-bezier(0.4,0,0.2,1)] ${className}`;
        
        const img = document.createElement('img');
        img.src = src;
        img.className = 'w-full h-full object-cover rounded-3xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] [transform:translateZ(50px)]';
      ...
      function updateSlideshow() {
        ...
        const prevSlide = createSlide(images[prevIndex], '[transform:rotateY(-180deg)_translateZ(100px)] opacity-0');
        const currentSlide = createSlide(images[currentImageIndex], '[transform:rotateY(0deg)_translateZ(100px)] opacity-100');
        const nextSlide = createSlide(images[nextIndex], '[transform:rotateY(180deg)_translateZ(100px)] opacity-0');
